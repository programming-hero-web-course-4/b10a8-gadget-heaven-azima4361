        ...
        <div className="relative rounded-xl border p-2 -top-36  ">
            <div>
                <div className="flex flex-col items-center gap-7 rounded-xl bg-purple-500 text-center text-white py-20">
                    ...
                    <p className="w-3/5 text-xl ">Explore the latest gadgets that will take your experience to the next level. From smart devices to the coolest accessories, we have it all!</p>
                    <Link to="/dashboard">
